...
# 2026 Knative Steering Committee End User Seat
...
| Date        | Event                                                   |
|-------------|---------------------------------------------------------|
| February 6  | Announce the intent to appoint end user representative  |
| February 27 | All candidate nominations due by 0000 UTC (4pm Pacific) |
| March 6     | Announcement of selection                               |

The one year term would be from March 6, 2026 to until a new representative is chosen in January 2027.
...
your candidate profile in the [`/elections/2026-SC-EU`](.) folder, with the following
filename format:
