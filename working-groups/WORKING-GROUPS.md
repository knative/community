...
| Slack Channel              | [#knative-serving](https://cloud-native.slack.com/archives/C04LMU0AX60) , [#knative](https://cloud-native.slack.com/archives/C04LGHDR9K7) (need to join [CNCF Slack](https://slack.cncf.io/) for the first time)                                      |
...
| Slack Channel              | [#knative](https://cloud-native.slack.com/archives/C04LGHDR9K7) + [#knative-documentation](https://cloud-native.slack.com/archives/C04LY5G9ED7) (need to join [CNCF Slack](https://slack.cncf.io/) for the first time)                            |
